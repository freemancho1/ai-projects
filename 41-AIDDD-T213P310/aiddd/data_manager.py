...
_PATH_READ_FILES = {
    ...
    '공사비 공사비': _get_path('공사비예산서', '5개년 공사비 예산서 추출내역_계약전력등추가.xlsx'),
...
_PATH_READ_WRITE_FILES = {
    '통계 전체': _get_path('전처리데이터', '통계 전체.csv'),
    '통계 1차전처리': _get_path('전처리데이터', '통계 1차전처리.csv'),
    '통계 2차전처리': _get_path('전처리데이터', '통계 2차전처리.csv'),
    '병합 전체카운트': _get_path('전처리데이터', '병합 전체카운트.csv'),
    '전처리 공사비': _get_path('전처리데이터', '전처리공사비.csv'),
    '전처리 공사비+설계': _get_path('전처리데이터', '전처리공사비_설계.csv'),
    '전처리 공사비+설계기별': _get_path('전처리데이터', '전처리공사비_설계기별.csv'),
